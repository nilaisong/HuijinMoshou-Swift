//
//  XTChangePasswordController.m
//  MoShou2
//
//  Created by xiaotei's MacBookPro on 16/12/15.
...
@implementation XTChangePasswordController{
...
-(void)createUI{
    ...
    [bigBtn setTitle:@"提交" forState:UIControlStateNormal];
