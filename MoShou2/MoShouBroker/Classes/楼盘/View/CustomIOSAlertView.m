...
- (UIView *)createContainerView
{
    ...
    lineView.alpha = 0.2;
    lineView.backgroundColor =UIColorFromRGB(0x888888);  // [UIColor blackColor];   //UIColorFromRGB(0xefeff4);
...
- (void)addButtonsToView: (UIView *)container
{
    ...
    for (int i=0; i<[buttonTitles count]; i++) {
        ...
        if (i == 0) {
            ...
            closeButton.titleLabel.font = FONT(16.f);
        
            UILabel *lineLabel = [[UILabel alloc]initWithFrame:CGRectMake(closeButton.width-1, 0, 0.5, closeButton.height)];
            lineLabel.backgroundColor = [UIColor blackColor];
            lineLabel.alpha = 0.1;
            [closeButton addSubview:lineLabel];
        
        }else if(i == 1){
            [closeButton setTitleColor:UIColorFromRGB(0x37aeff) forState:UIControlStateNormal];
            closeButton.titleLabel.font = FONT(16.f);

        }
        [closeButton setTitle:[buttonTitles objectForIndex:i] forState:UIControlStateNormal];
