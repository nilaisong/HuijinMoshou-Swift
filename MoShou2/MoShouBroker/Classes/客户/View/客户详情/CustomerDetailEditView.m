...
@implementation CustomerDetailEditView
...
- (void)layoutUI
{
    ...
    [btn0 setTitle:@"编辑客户" forState:UIControlStateNormal];
    ...
    [btn1 setTitle:@"删除客户" forState:UIControlStateNormal];
    ...
    [btn2 setTitle:@"移动至" forState:UIControlStateNormal];
