...
@implementation XTDateSelectView
...
- (void)commonInit{
    ...
    = [[UUDatePicker alloc]initWithframe:CGRectMake(0, [UIScreen mainScreen].bounds.size.height - 216,[UIScreen mainScreen].bounds.size.width, 216)
