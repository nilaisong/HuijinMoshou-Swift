...
- (void)setRemindResult:(RemindResult *)remindResult{
    ...
    MobileVisible* mobile = [remindResult.phoneList firstObject];
    CGSize phoneLabelSize = [NSString sizeWithString:mobile.hidingPhone font:[UIFont systemFontOfSize:10] maxSize:CGSizeMake(MAXFLOAT, 10)];
