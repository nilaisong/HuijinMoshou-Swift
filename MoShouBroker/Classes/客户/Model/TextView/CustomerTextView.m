...
- (void)setup
{
    ...
    _placeHolderTextColor = TFPLEASEHOLDERCOLOR;
...
- (void)setPlaceHolder:(NSString *)placeHolder
{
    ...
    NSUInteger maxChars = [CustomerTextView maxCharactersPerLine];
...
{
    return [CustomerTextView numberOfLinesForMessage:self.text];
}
...
{
    return (text.length / [CustomerTextView maxCharactersPerLine]) + 1;
}
