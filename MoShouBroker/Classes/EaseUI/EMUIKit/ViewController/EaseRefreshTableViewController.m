...
//    }
    ...
    _tableView = [[UITableView alloc] initWithFrame:CGRectMake(0, 64, kMainScreenWidth,kMainScreenHeight-64) style:self.style];
...
//                [weakSelf.tableView.legendHeader beginRefreshing];
//            }];
