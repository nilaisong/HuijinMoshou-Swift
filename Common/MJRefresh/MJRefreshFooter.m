...
- (void)adjustStateWithContentOffset
{
    ...
    if (_scrollView.mj_insetT + _scrollView.mj_contentSizeH > _scrollView.mj_h) { // 内容超过一个屏幕
        ...
        if (_scrollView.mj_offsetY > _scrollView.mj_contentSizeH - _scrollView.mj_h + self.mj_h * self.appearencePercentTriggerAutoRefresh - self.mj_h)//+ _scrollView.mj_insetB ,2015-11-11,nls
        {
            // 当底部刷新控件完全出现时，才刷新
            [self beginRefreshing];
        }
