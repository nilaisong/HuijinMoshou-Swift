...
@class MJRefreshGifHeader, MJRefreshLegendHeader, MJRefreshHeader, MJRefreshMessageHeader;
...
@property (nonatomic, readonly) MJRefreshMessageHeader *messageHeader;
#pragma mark - 新添加的头部刷新
