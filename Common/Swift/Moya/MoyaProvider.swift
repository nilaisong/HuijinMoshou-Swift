...
open class MoyaProvider<Target: TargetType>: MoyaProviderType {
    ...
    open internal(set) var inflightRequests: [Endpoint<Target>: [Completion]] = [:]
    ...
    @discardableResult
    open func stubRequest(_ target: Target, request: URLRequest, callbackQueue: DispatchQueue?, completion: @escaping Completion, endpoint: Endpoint<Target>, stubBehavior: StubBehavior) -> CancellableToken {
        let callbackQueue = callbackQueue ?? self.callbackQueue
...
public extension MoyaProvider {
    ...
    public final class func delayedStub(_ seconds: TimeInterval) -> (Target) -> StubBehavior {
