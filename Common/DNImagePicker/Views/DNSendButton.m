...
- (void)setupViews
{
    ...
    _backGroudView.backgroundColor = [UIColor colorWithHexString:dnSendButtonTintNormalColor];
    ...
    self.sendButton.frame = CGRectMake(0, 0, self.width, self.height);
    [self.sendButton setTitle:@"完成"
                 forState:UIControlStateNormal];
    [self.sendButton setTitleColor:[UIColor colorWithHexString:dnSendButtonTintNormalColor] forState:UIControlStateNormal];
    [self.sendButton setTitleColor:[UIColor colorWithHexString:dnSendButtonTintAbnormalColor] forState:UIControlStateHighlighted];
    [self.sendButton setTitleColor:[UIColor colorWithHexString:dnSendButtonTintAbnormalColor] forState:UIControlStateDisabled];
    self.sendButton.titleLabel.font = [UIFont systemFontOfSize:15.0f];
    self.sendButton.contentEdgeInsets = UIEdgeInsetsMake(0, 20, 0, 0);
